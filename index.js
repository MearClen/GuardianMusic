...
bot.on("guildCreate", (guild) => {
    ...
    if (generalChannel){
        ...
        .setTitle('Check out the GuardianMusic Website!')
        .setAuthor('GuardianMusic', 'https://cdn.discordapp.com/attachments/825725013008580678/834617630525751296/1242737_full.png', 'https://mearclen.carrd.co/')
        .setColor('0x00AE86')
        .setDescription("The prefix for GuardianMusic is set as "+ PREFIX +" in your server.")
        .setFooter('GuardianMusic o.O', 'https://cdn.discordapp.com/attachments/825725013008580678/834617630525751296/1242737_full.png')
        .setThumbnail('https://cdn.discordapp.com/attachments/825725013008580678/834617630525751296/1242737_full.png')
        .setTimestamp()
        .setURL('https://mearclen.carrd.co/')
        .addField(PREFIX+'help', 'Opens this help menu.', true)
        .addField(PREFIX+'helpme', 'Sends you the help menu on DM.', true)
        .addField(PREFIX+'invite', 'Invite GuardianMusic to your server !', true)
        ...
        generalChannel.send('Hey there! Here is a quickstart guide on how to use GuardianMusic!')
...
bot.on("message", async (msg) => { 
    ...
    msg.react('<:GuardianMusic:834623021674266685>');
...
**Now Playing: \`${serverQueue.songs[0].title}\`**
        ...
        .setColor('0x00AE86')
        .setTitle('Invite GuardianMusic to your server!')
        .setURL('https://discord.com/oauth2/authorize?client_id=834589126451265556&scope=bot&permissions=7553941441');
        ...
        const invembed = new MessageEmbed()
        .setColor('0x00AE86')
        .setTitle('Angkat masalah hubungi di Website!')
        .setURL('https://mearclen.carrd.co/');
        res = await msg.channel.send(invembed);  
        msg.channel.send('Or join the GuardianMusic support server for any queries 💬');
        msg.channel.send('https://discord.gg/PYpA2b9AjZ');      
    }
